...
@objc public protocol Article: CreativeWork {
    ...
    var wordCountRawValue: NSNumber? { get set }
}

public extension Article {
    var wordCount: Int? {
        get {
            guard let rawValue = wordCountRawValue?.intValue else {
                return nil
            }
        ...
        set {
            guard let rawValue = newValue else {
                wordCountRawValue = nil
                return
            }
            
            wordCountRawValue = NSNumber(value: rawValue)
        }
    }
}
